...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg"><b>NEU</b>CSE</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="source/neu.jpg" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="source/neu.jpg" class="img-circle" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>计算机科学与工程学院</p>
                    <!-- Status -->
                    <a href="#"><i class="fa fa-circle text-success"></i> 东北大学</a>
                </div>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="#"><i class="icon-home"></i> <span>后台首页</span></a></li>

                @if(NULL==session('user'))
                    <li class="treeview">
                        <a href="#"><i class="icon-folder-open-alt"></i> <span>新闻管理</span>
                            <span class="pull-right-container">
<i class="icon-angle-right"></i>
</span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a  href="#">发布新闻系统</a></li>
                            <li><a  href="#">更新新闻系统</a></li>
                        </ul>
                    </li>
...
<i class="icon-angle-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a  href="#">新闻评论管理系统</a></li>
                            <li><a  href="#">新闻分享管理系统</a></li>
                        </ul>
                    </li>
...
<i class="icon-angle-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a  href="#" >竞赛奖项颁布</a></li>
                            <li><a  href="#" >竞赛获奖查询</a></li>
                            <li><a  href="#" >获奖信息导入</a></li>
                        </ul>
                    </li>
...
<i class="icon-angle-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a  href="#" >注册学生管理</a></li>
                            <li><a  href="#" >注册教师管理</a></li>
                        </ul>
                    </li>-->
                    <li><a href="#"><i class="icon-wrench"></i> <span>使用帮助</span></a></li>
                @else
                    <li class="treeview">
                        <a href="#"><i class="icon-reorder"></i> <span>信息管理</span>
                            <span class="pull-right-container">
<i class="icon-angle-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a  href="#">参赛学生管理系统</a></li>
                            <li><a  href="#">参赛团队管理系统</a></li>
                        </ul>
                    </li>
